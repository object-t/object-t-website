...
export interface FigmaLinkProps {
    url: string; 
    label?: string;
...
export const FigmaLink = ({
    ...
    return (
        <a href={url} className="Figma-link" style={linkStyle} target="_blank" rel="noopener noreferrer" {...props}>
            <span className="Figma-label" style={wordStyle}>{label}</span>
            <svg
